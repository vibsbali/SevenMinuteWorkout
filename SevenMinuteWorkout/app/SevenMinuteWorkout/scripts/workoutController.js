...
(function () {
    angular.module("7minWorkout").controller("WorkoutController", ["$interval", "$location", function ($interval, $location) {
        ...
        //We will start with creating a workout which include exercises 
        //This is a Workout plan object
        ...
        //First we need an array of exercises to perform which means create an object of type Exercise
        //This is an Exercise object which includes various properties such as name, title, image, procedure etc
        ...
        //This Method allows us to start an exercise
        ...
        //This is a kind of module revealing pattern - creates a fully built WorkoutPlan 
        var createWorkout = function () {
            ...
            workout.exercises.push({
                details: new Exercise({
                    ...
                    nameSound: "/app/resources/jumpingjacks.wav",
            ...
            workout.exercises.push({
                details: new Exercise({
                    ...
                    nameSound: "/app/resources/wallsit.wav",
            ...
            workout.exercises.push({
                details: new Exercise({
                    ...
                    nameSound: "/app/resources/pushups.wav",
            ...
            workout.exercises.push({
                details: new Exercise({
                    ...
                    nameSound: "/app/resources/crunches.wav",
